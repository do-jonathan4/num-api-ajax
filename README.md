...
This one uses XMLHttpRequest. Checkout the [fetch](https://github.com/do-jonathan4/num-api-fetch) and [axios](https://github.com/do-jonathan4/num-api-axios) versions.
